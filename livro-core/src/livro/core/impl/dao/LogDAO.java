...
public class LogDAO extends AbstractJdbcDAO {
	...
	public void salvar(EntidadeDominio entidade) {
		...
		LivroLog livro = (LivroLog) entidade;
		...
		try {
			...
			sql.append("INSERT INTO log(codigo_livro, autor, ano, status, titulo, editora, edicao, isbn,"
					+ "num_paginas, sinopse, altura, peso, profundidade, usuario, id_livro) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
			...
			pst.setString(14, livro.getUsuario());
	...
	public void alterar(EntidadeDominio entidade) {
		...
		try {
			...
			sb.append("INSERT INTO livros(codigo_livro, autor, ano, status, titulo, editora, edicao, isbn,"
					+ "num_paginas, sinopse, altura, peso, profundidade, usuario, id_livro) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
